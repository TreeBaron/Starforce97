...
function App() {
  ...
  const [player, setPlayer] = useState<Starship | null>(null);
    ...
    return (
      <div className="rowS blackBackground">
        ...
        <div className="colS blackBackground">
          ...
          <ShipLog world={world} player={player} />
          ...
          <div className="rowS">
            <Button
              ...
              onClick={() => {
                ...
                setWorld(localWorld);
                setPlayer(localWorld.GetPlayer());
          ...
          >
            ...
            <Modal.Body className="primaryBackground color1">
              ...
              <ul>
                ...
                <li>(!) - Enemy torpedo, don't get hit!</li>
              ...
              <ul>
                <li>
                  It is very important to understand that stealth is an element
                  in this game.
                </li>
                <li>
              ...
              <ul>
                ...
                <li>
                  Quadrant movement lets you move faster, but it costs more
                  energy and can cause you to jump onto or next to an enemy so
                  it is slightly risky.
                </li>
                <li>
                  The quadrant map wraps kind of like pac-man. So if you exit
                  one side you will appear on the other side.
                </li>
              </ul>
              <h3>Energy</h3>
              <ul>
                ...
                <li>
                  Waiting at a planet will recharge your batteries faster.
                </li>
              </ul>
              <h3>Combat</h3>
              <ul>
                <li>
                  Your ship can use lasers or torpedoes to attack enemies.
                </li>
                <li>
                  Torpedoes take no energy to use, but you have a limited
                  amount. There is no way to gain more torpedoes once they are
                  gone they are gone.
                </li>
                <li>
                ...
                <li>
                  ...
                  getting close to a target however and if you are in laser
                  range the enemy can detect you.
                </li>
                <li>
                ...
                <li>
                  Lasers can knock out random ship systems, so they might
                  cripple your ability to move or fire torpedoes among other
                  things.
                </li>
        ...
        <>
          <div className="rowS blackBackground">
            <div className="colS">
              ...
              />
              <ShipLog world={world || ({} as World)} player={player} />
            </div>
            <div className="colS">
              <StarshipDisplay
